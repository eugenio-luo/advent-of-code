...
void parse(const std::string& line, std::vector<Pair*>& numbers, Pair* basePair) {
...
void convert(std::istream& input, std::vector<Pair*>& numbers) {
    std::string line;
